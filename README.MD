...
A notable exception is HEIF/HEIC images from Apple devices.

<details>

    <summary>Automatic HEIC to JGP conversion on IOS devices</summary>

    But such devices allow for exporting HEIC photos as JPGs thus:
